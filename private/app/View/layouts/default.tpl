                            ...
                            <div class="leftblock">
                                ...
                                <div class="cntnt-leftblock">
                                    <div id="contacts">
                                        ...
                                        <br>г. Орел, Наугорское шоссе, 40
                                        <br><strong>Телефоны</strong>
                                        <br>(4862) 40-96-14, (4862) 43-09-44
                                        <br><b><a href="http://uchimvas.ru/pismo" title="Обратная связь">Обратная связь</a></b>
                                    </div>
                                </div>
                            </div>
                            <noindex>
                                ...
                                <div class="leftblock">
                                    ...
                                    <div class="cntnt-leftblock">
                                        <form name="" action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <input name="" src="<?php echo $this->_links->getPath('/files/images/icon_search.gif') ?>" class="button" type="image">
                                        </form>
                                    </div>
                                </div>
                            </noindex>
