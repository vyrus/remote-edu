...
<tr class="odd"><th class="description">Название</th></tr>
<?php if (! empty ($materials)): ?>
<?php foreach ($materials as $i => $material): ?>
<tr<?php if ($i % 2): ?> class="odd"<?php else: ?> class="even"<?php endif; ?>><td class="description"><a href="/educational_material/<?php echo $material['id']; ?>"><?php echo $material['description']; ?></a></td></tr>
<?php endforeach; ?>
<?php endif; ?>
</table>
