...
<ol>
	...
	<li><b>принята</b> - Ваша заявка принята, идет формирование договора;</li>
	...
	<li><b>подписана</b> - у Вас имеется задолжность по оплате, в разделе <a href="<?php echo $this->_links->get('student.programs') ?>">Мои
	курсы</a> Вам доступны материалы для обучения по данной программе;</li>
	<li><b>оплачена</b> - заявка Вами была оплачена полностью;</li>
	<li><b>окончена</b> - Вы закончили обучение по данной программе.
</ol>
<p>
