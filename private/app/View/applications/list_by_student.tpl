...
<ol>
	...
	<li><b>подписана</b> - в разделе <a href="/education_programs/available/">Мои курсы</a> Вам доступны материалы для обучения по данной программе.</li>
</ol>
<p>
Также, ещё возможен вариант когда Вам потребуется заключить договор на обучение, в этом случае ссылка на него появится в колонке "Договор". <a href="/users/howtostart/">Перейти к инструкции</a>.
<p>
